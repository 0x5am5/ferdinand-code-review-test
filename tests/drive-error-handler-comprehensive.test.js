...
import { parseDriveError, calculateBackoff, DriveErrorCode, } from '../server/services/drive-error-handler';
// ============================================================================
 ...
 */
function createGaxiosError(statusCode, reason, message, headers) {
    const error = {
        response: {
            status: statusCode,
