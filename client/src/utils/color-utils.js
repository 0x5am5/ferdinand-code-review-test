...
export function generateTintsAndShades(hex, tintPercents = [60, 40, 20], shadePercents = [20, 40, 60]) {
...
export function generateNeutralPalette(baseGrey) {
...
export function generateContainerColors(baseColor) {
...
export function isColorFamily(hex, family) {
...
export function extractBrandColorProperties(brandColors, baseGreyHex = null, regenerationCount = 0) {
    let baseHue = 0;
...
export function generateInteractiveColors(brandColors) {
