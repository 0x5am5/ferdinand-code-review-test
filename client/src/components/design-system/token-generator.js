...
export function generateSemanticTokens(rawTokens) {
    ...
    const colors = {
        ...
        buttonPrimaryBg: rawTokens.components.button.primaryBackgroundColor === "brandPrimaryBase"
        ...
        buttonSecondaryText: rawTokens.components.button.secondaryTextColor === "brandPrimaryBase"
            ? rawTokens.colors.brandPrimaryBase
    ...
    return {
        ...
        shadows: {
            elevationCard: "0 1px 3px rgba(0, 0, 0, 0.12), 0 1px 2px rgba(0, 0, 0, 0.24)",
            elevationModal: "0 10px 25px rgba(0, 0, 0, 0.15), 0 4px 10px rgba(0, 0, 0, 0.1)",
