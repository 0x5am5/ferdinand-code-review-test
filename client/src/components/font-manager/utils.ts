...
export const convertGoogleFontCategory = (category: string): string => {
...
export const generateGoogleFontUrl = (
  fontName: string,
  weights: string[] = ["400"],
...
export const parseFontAsset = (asset: BrandAsset): FontData | null => {
  try {
    const data =
