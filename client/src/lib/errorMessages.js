...
export function getUserFriendlyErrorMessage(error) {
    ...
    if (message.includes("INVITATION_EXISTS") ||
    ...
    if (message.includes("EMAIL_QUOTA_EXCEEDED") ||
        message.includes("quota") ||
        message.includes("credits")) {
        return ERROR_MESSAGES.EMAIL_QUOTA_EXCEEDED;
    }
    if (message.includes("EMAIL_INVALID_CREDENTIALS") ||
        message.includes("credentials") ||
        message.includes("configuration")) {
        return ERROR_MESSAGES.EMAIL_INVALID_CREDENTIALS;
    }
    if (message.includes("EMAIL_INVALID_ADDRESS") ||
    ...
    if (message.includes("EMAIL_SERVICE_UNAVAILABLE") ||
        message.includes("unavailable")) {
        return ERROR_MESSAGES.EMAIL_SERVICE_UNAVAILABLE;
    }
    if (message.includes("EMAIL_SERVICE_FAILED") ||
