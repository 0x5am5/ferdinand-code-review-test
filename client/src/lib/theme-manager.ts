  ...
  private generateVariantColors(
    ...
    switch (variant) {
      ...
      case "vibrant": {
        ...
        colors["secondary"] =
          `hsl(${triadicHue1}, ${Math.min(s * 0.9, 70)}%, ${l}%)`;
        colors["tertiary"] =
          `hsl(${triadicHue2}, ${Math.min(s * 0.9, 70)}%, ${l}%)`;

        // Generate secondary and tertiary variants
        colors["secondary-tint-1"] = this.generateTint(
          colors["secondary"],
          0.8
        );
        colors["secondary-tint-2"] = this.generateTint(
          colors["secondary"],
          0.9
        );
        colors["secondary-shade-1"] = this.generateShade(
          colors["secondary"],
          0.8
        );
        colors["secondary-shade-2"] = this.generateShade(
          colors["secondary"],
          0.9
        );
        ...
        colors["tertiary-shade-1"] = this.generateShade(
          colors["tertiary"],
          0.8
        );
        colors["tertiary-shade-2"] = this.generateShade(
          colors["tertiary"],
          0.9
        );
