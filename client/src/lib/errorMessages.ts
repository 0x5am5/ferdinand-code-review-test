...
export const ERROR_MESSAGES = {
  EMAIL_EXISTS:
    "This email address is already registered. Please try a different email address.",
  INVITATION_EXISTS:
    "This person has already been invited. You can resend the invitation if needed.",
...
export function getUserFriendlyErrorMessage(error: Error): string {
  ...
  if (Object.values(ERROR_MESSAGES).includes(message as string)) {
    return message;
  }
  ...
  if (
    message.includes("INVITATION_EXISTS") ||
    message.includes("invitation with this email already exists")
  ) {
  ...
  if (
    ...
    message.includes("invitation has expired")
  ) {
  ...
  if (
    message.includes("EMAIL_QUOTA_EXCEEDED") ||
  ...
  if (
    message.includes("EMAIL_INVALID_CREDENTIALS") ||
  ...
  if (
    message.includes("EMAIL_INVALID_ADDRESS") ||
  ...
  if (
    message.includes("EMAIL_SERVICE_UNAVAILABLE") ||
  ...
  if (
    message.includes("EMAIL_SERVICE_FAILED") ||
