...
export function useUserClientAssignmentsQuery(userIds) {
    return useQuery({
        ...
        queryFn: async () => {
            try {
                ...
                console.error("Failed to fetch client assignments:", error instanceof Error ? error.message : "Unknown error");
                return {};
            }
        },
