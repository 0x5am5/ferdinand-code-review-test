...
export function convertColor(hex, pantone) {
...
export function formatColorForCopy(format, colorFormats) {
    switch (format) {
        case "rgb":
...
export function getPantoneValue(colorId) {
    if (typeof window !== "undefined") {
        return localStorage.getItem(`pantone-${colorId}`) || "";
    }
    return "";
}
export function setPantoneValue(colorId, value) {
    if (typeof window !== "undefined") {
        if (value) {
