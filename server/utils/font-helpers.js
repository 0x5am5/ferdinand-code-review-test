// Helper functions
export function hasUploadableFiles(asset) {
    try {
...
export const FONT_CATEGORY_EMOJIS = {
    brand: "🎯",
    body: "📖",
    header: "📰",
    other: "📝",
...
export function buildFontBlocks(displayAssets, filteredFontAssets, fontAssets, variant) {
