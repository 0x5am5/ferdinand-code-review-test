...
export const COLOR_CATEGORY_EMOJIS = {
    brand: "🎯",
    neutral: "⚫",
    interactive: "🔗",
    color: "🎨",
};
export const COLOR_CATEGORY_NAMES = {
    brand: "Brand Colors",
...
export function buildColorBlocks(displayAssets, filteredColorAssets, colorAssets, variant) {
    // Group assets by category for better organization
    const groupedAssets = displayAssets.reduce((groups, asset) => {
        try {
...
export function buildColorConfirmationBlocks(displayAssets, variant, workspaceClientId) {
    return [
        {
            type: "section",
            text: {
...
export function buildColorProcessingMessage(displayAssets, variant) {
    return variant
...
export function buildColorSummaryMessage(displayedCount, totalCount, variant, responseTime) {
...
export function shouldShowColorConfirmation(colorCount) {
    return colorCount > 5;
}
