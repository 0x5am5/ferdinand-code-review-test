 ...
 */
export async function convertToAllFormats(fileBuffer, originalFormat, assetId) {
 ...
 */
async function handleRasterFile(fileBuffer, originalFormat, convertedFiles) {
    ...
    if (originalFormat.toLowerCase() !== "jpg" &&
 ...
 */
async function handleVectorFile(fileBuffer, originalFormat, convertedFiles, tempDir) {
    // For SVG conversions
