import { assetCategories, typeScales as typeScalesTable, } from "@shared/schema";
...
async function migrateTypeScaleHierarchy() {
    try {
        ...
        console.error("Error migrating type scale hierarchy:", error instanceof Error ? error.message : "Unknown error");
        throw error;
    }
}
async function migrateDefaultAssetCategories() {
    try {
        ...
        console.error("Error creating default asset categories:", error instanceof Error ? error.message : "Unknown error");
        throw error;
    }
}
