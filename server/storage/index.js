 ...
 */
export async function generateSignedUrl(storagePath, expiresIn = 3600) {
    if (storageConfig.type === "s3" || storageConfig.type === "r2") {
 ...
 */
export function getFullPath(storagePath) {
    if (storageConfig.type === "s3" || storageConfig.type === "r2") {
...
export { generateStoragePath, generateUniqueFileName, isRiskyFileType, storageConfig, validateFileSize, validateMimeType, } from "./config";
