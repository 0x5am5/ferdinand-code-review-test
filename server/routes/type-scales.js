...
export function registerTypeScalesRoutes(app) {
    ...
    app.get("/api/clients/:clientId/type-scales", async (req, res) => {
        try {
            ...
            const migratedTypeScales = typeScales.map((typeScale) => {
                const currentTypeStyles = typeScale.typeStyles || [];
                const hasNewStructure = currentTypeStyles.some((style) => ["body-large", "body-small", "caption", "quote", "code"].includes(style.level));
                if (!hasNewStructure) {
            ...
            console.error("Error fetching type scales:", error instanceof Error ? error.message : "Unknown error");
    ...
    app.get("/api/type-scales/:id", async (req, res) => {
        try {
            ...
            console.error("Error fetching type scale:", error instanceof Error ? error.message : "Unknown error");
    ...
    app.post("/api/clients/:clientId/type-scales", async (req, res) => {
        try {
            ...
            console.error("Error creating type scale:", error instanceof Error ? error.message : "Unknown error");
    ...
    app.patch("/api/type-scales/:id", async (req, res) => {
        try {
            ...
            console.error("Error updating type scale:", error instanceof Error ? error.message : "Unknown error");
    ...
    app.delete("/api/type-scales/:id", async (req, res) => {
        try {
            ...
            console.error("Error deleting type scale:", error instanceof Error ? error.message : "Unknown error");
    ...
    app.post("/api/type-scales/:id/export/css", async (req, res) => {
        try {
            ...
            console.error("Error generating CSS export:", error instanceof Error ? error.message : "Unknown error");
    ...
    app.post("/api/type-scales/:id/export/scss", async (req, res) => {
        try {
            ...
            console.error("Error generating SCSS export:", error instanceof Error ? error.message : "Unknown error");
...
function calculateFontSize(baseSize, ratio, step, unit) {
...
function generateCSS(typeScale) {
...
function generateSCSS(typeScale) {
    const { baseSize, scaleRatio, unit, typeStyles } = typeScale;
    const actualRatio = scaleRatio / 1000;
