...
export function registerFigmaRoutes(app) {
    ...
    app.get("/api/figma/connections/:clientId", async (req, res) => {
        try {
            ...
            const connections = await storage.getFigmaConnections(parseInt(clientId, 10));
            ...
            console.error("Error fetching Figma connections:", error instanceof Error ? error.message : "Unknown error");
    ...
    app.post("/api/figma/test-connection", async (req, res) => {
        try {
            ...
            console.error("Error testing Figma connection:", error instanceof Error ? error.message : "Unknown error");
    ...
    app.post("/api/figma/files", async (req, res) => {
        try {
            ...
            if (data.projects) {
                for (const project of data.projects) {
                    ...
                    if (projectResponse.ok) {
                        ...
                        files.push(...projectData.files.map((file) => ({
                            key: file.key,
                            name: file.name,
            ...
            console.error("Error fetching Figma files:", error instanceof Error ? error.message : "Unknown error");
    ...
    app.post("/api/figma/connections", async (req, res) => {
        try {
            ...
            console.error("Error creating Figma connection:", error instanceof Error ? error.message : "Unknown error");
    ...
    app.get("/api/figma/connections/:connectionId/tokens", async (req, res) => {
        try {
            ...
            const connection = await storage.getFigmaConnection(parseInt(connectionId, 10));
            if (!connection) {
            ...
            console.error("Error fetching Figma tokens:", error instanceof Error ? error.message : "Unknown error");
    ...
    app.post("/api/figma/connections/:connectionId/sync-from-figma", async (req, res) => {
        try {
            ...
            console.error("Error syncing from Figma:", error instanceof Error ? error.message : "Unknown error");
    ...
    app.delete("/api/figma/connections/:connectionId", async (req, res) => {
        try {
            ...
            console.error("Error deleting Figma connection:", error instanceof Error ? error.message : "Unknown error");
    ...
    app.get("/api/figma/connections/:connectionId/sync-logs", async (req, res) => {
        try {
            ...
            const logs = await storage.getFigmaSyncLogs(parseInt(connectionId, 10), parseInt(limit, 10), parseInt(offset, 10));
            res.json(logs);
        }
        catch (error) {
            console.error("Error fetching sync logs:", error instanceof Error ? error.message : "Unknown error");
