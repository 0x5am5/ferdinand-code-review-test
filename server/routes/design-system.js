...
function generateSemanticTokens(rawTokens) {
...
function generateNeutralScale(neutralBase) {
    try {
        ...
        console.error("Error generating neutral scale:", error instanceof Error ? error.message : "Unknown error");
        // Fallback to default gray scale
        return [
            "#ffffff",
            "#f8f9fa",
...
function generateColorVariations(baseColor) {
    try {
        ...
        console.error("Error generating color variations for", baseColor, error instanceof Error ? error.message : "Unknown error");
        // Fallback variations
        return {
            xLight: baseColor,
            light: baseColor,
...
export function registerDesignSystemRoutes(app) {
    ...
    app.get("/api/design-system", async (req, res) => {
        try {
            ...
            console.error("Error fetching design system:", error instanceof Error ? error.message : "Unknown error");
    ...
    app.patch("/api/design-system", async (req, res) => {
        try {
            ...
            try {
                ...
                console.error("Error reading existing theme.json:", error instanceof Error ? error.message : "Unknown error");
            }
            ...
            console.error("Error updating design system:", error instanceof Error ? error.message : "Unknown error");
    ...
    app.patch("/api/design-system/typography", async (req, res) => {
        try {
            ...
            console.error("Error updating typography settings:", error instanceof Error ? error.message : "Unknown error");
        ...
        try {
            ...
            if (!rawTokens) {
                return res.status(400).json({
                    message: "No design tokens found. Please configure your design system first.",
                });
            }
...
`;
            ...
            console.error("Error exporting CSS:", error instanceof Error ? error.message : "Unknown error");
            res.status(500).json({
                message: "Error exporting CSS",
                error: error.message,
            });
        }
    });
...
`;
            ...
            console.error("Error exporting SCSS:", error instanceof Error ? error.message : "Unknown error");
            res.status(500).json({
                message: "Error exporting SCSS",
                error: error.message,
            });
        }
    });
                    ...
                    ({ addComponents, theme, }) => {
                        addComponents({
                            ".btn": {
                                ...
                                border: "none",
                                cursor: "pointer",
                                transition: theme("transitionDuration.button") +
                                    " " +
                            ...
                            ".input": {
                                ...
                                transition: theme("transitionDuration.input") +
                                    " " +
...
`;
            ...
            console.error("Error exporting Tailwind config:", error instanceof Error ? error.message : "Unknown error");
            res.status(500).json({
