import { clients, insertUserClientSchema, invitations, UserRole, userClients, users, } from "@shared/schema";
...
export function registerUserRoutes(app) {
    ...
    app.get("/api/user/clients", async (req, res) => {
        try {
            ...
            console.error("Error fetching user clients:", error instanceof Error ? error.message : "Unknown error");
    ...
    app.post("/api/users/:id/reset-password", async (req, res) => {
        try {
            ...
            console.error("Error sending password reset:", error instanceof Error ? error.message : "Unknown error");
    ...
    app.post("/api/reset-password", async (req, res) => {
        try {
            ...
            console.error("Error processing reset:", error instanceof Error ? error.message : "Unknown error");
            res
                .status(500)
    ...
    app.get("/api/users/client-assignments", async (_req, res) => {
        try {
            ...
            console.error("Error fetching client assignments:", error instanceof Error ? error.message : "Unknown error");
    ...
    app.post("/api/user-clients", csrfProtection, async (req, res) => {
        try {
            ...
            console.error("Error creating user-client relationship:", error instanceof Error ? error.message : "Unknown error");
    ...
    app.delete("/api/user-clients/:userId/:clientId", csrfProtection, async (req, res) => {
        try {
            ...
            console.error("Error deleting user-client relationship:", error instanceof Error ? error.message : "Unknown error");
            res
                .status(500)
    ...
    app.get("/api/clients/:clientId/users", validateClientId, async (req, res) => {
        try {
            ...
            console.error("Error fetching client users:", error instanceof Error ? error.message : "Unknown error");
