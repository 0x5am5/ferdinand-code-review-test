...
import { deleteFile, downloadFile, fileExists, uploadFile, } from "../storage/index";
 ...
 */
export function getThumbnailStoragePath(assetId, size) {
    return `thumbnails/${size}/${assetId}.jpg`;
}
/**
 * Check if a thumbnail exists in storage
 */
export async function thumbnailExists(assetId, size) {
 ...
 */
async function generatePdfThumbnail(sourcePath, dimensions) {
    try {
 ...
 */
export async function generateThumbnail(sourcePath, assetId, size, mimeType) {
 ...
 */
export async function getOrGenerateThumbnail(sourcePath, assetId, size, mimeType) {
    const storagePath = getThumbnailStoragePath(assetId, size);
 ...
 */
export async function downloadThumbnail(assetId, size) {
    const storagePath = getThumbnailStoragePath(assetId, size);
 ...
 */
export async function deleteThumbnails(assetId) {
